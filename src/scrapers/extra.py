"""
Scraper específico para Extra Mercado.
...
from config.markets import EXTRA_CONFIG
...
class ExtraScraper(BaseScraper):
    """
    Scraper para Extra Mercado.
    Parte do grupo GPA, estrutura similar ao Pão de Açúcar.
    """
    
    def __init__(self, config=None):
        """Inicializa o scraper."""
        super().__init__(config or EXTRA_CONFIG)
    ...
    async def extract_products(
        ...
        """
        Extrai produtos da página de resultados do Extra.
        """
        products = []
